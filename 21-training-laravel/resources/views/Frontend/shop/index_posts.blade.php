...
<head>
    ...
    <link rel="stylesheet" href="front/st/css/animate.css">
            ...
            <div class="container">
                <div class="pull-left auto-width-left">
                    <ul class="top-menu menu-beta l-inline">
                        ...
                        <li><a href=""><i class="fa fa-phone"></i> 0163 296 1234</a></li>
                    </ul>
                </div>
        ...
        <div class="header-body">
            <div class="container beta-relative">
                ...
                <div class="pull-right beta-components space-left ov">
                    ...
                    <div class="beta-comp">
                        <form role="search" method="get" id="searchform" action="/ad/search">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href=""><img src="/upbaiviet/{{$pro->hinhanh}}" alt="" width="150px"></a>
                            </td>
                            <td>
                                <b>
                                    <h5 class="other-title">{{$pro->tenbaiviet}}</h5>
                                </b>
                            </td>
                            <td>
                                {{$pro->product_name}}
