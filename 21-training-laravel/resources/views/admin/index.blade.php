    ...
    <section id="container">
		...
		?>
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li><a href="{{URL::to('/ad/logout')}}"><i class="fa fa-key"></i> Đăng Xuất</a></li>
                        </ul>
                    </li>
                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{URL::to('/ad/add_category_product')}}">Thêm Danh Mục Và Sản Phẩm</a></li>
                                <li><a href="{{URL::to('/ad/all_category_product')}}">Liệt Kê Danh Mục Và Sản Phẩm</a>
                                </li>
                            </ul>
                        </li>
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{URL::to('/ad/add_brand_product')}}">Thêm Thương Hiệu Sản Phẩm</a></li>
                                <li><a href="{{URL::to('/ad/all_brand_product')}}">Liệt Kê Thương Hiệu</a></li>
                            </ul>
                        </li>
                        <li class="sub-menu">
                            <a href="javascript:;">
                            ...
                            <ul class="sub">
                                <li><a href="{{URL::to('/ad/add_product')}}">Thêm Sản Phẩm</a></li>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="/ad/Post_SP/">Hien Thi Bài Viết</a></li>
                            </ul>
                        </li>
                        <li class="sub-menu">
                            <a href="javascript:;">
