...
<head>
	...
	<title>Levents - Registration</title>
			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> Thành Phố Hồ Chí Minh</a></li>
					...
					<div class="col-sm-12">
						<div class="beta-products-list">
                            <div class="container">
                                ...
                                <form action="{{ route('registration.post')}}" method="POST" class="ms-auto me-auto mt-3" style="width: 500px; padding-top: 2cm">
                                    @csrf
